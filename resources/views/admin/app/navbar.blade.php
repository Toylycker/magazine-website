<nav class="navbar navbar-expand-lg navbar-dark py-3 {{ Route::current()->getName() == 'partners' ? '' : 'sticky-top' }}" aria-label="Fifth navbar example">
    <div class="container-xl text-center">
        <a class="navbar-brand navbar-brand-dynamic-color fade-page glow-on-hover" href="{{ route('home') }}"><img src="{{ asset('img/akenmar-pr-agency.png') }}" width="150" height="40"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav ms-auto text-center">
                ...
                @endauth
                <li class="nav-item">
                    <a class="text-white nav-link fw-bold a" href="{{ route('home2') }}"> @lang('app.home2') </a>
                </li>
                <li class="nav-item">
