...
<div class="d-flex justify-content-center align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 {{$dark?'text-white':'text-dark'}}">@lang('app.subjects')</h1>
</div>
<div class="text-center">
    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#createsubject">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.blogs.subject.store') }}" method="post" id="subjectform" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                ...
                <div class="modal-footer">
                    <a class="btn btn-success" href="{{ route('admin.blogs.subject.store') }}" onclick="event.preventDefault(); document.getElementById('subjectform').submit();">
                        @lang('app.submit')
                    </a>
                </div>
            </div>
    ...
    <table class="table table-hover table-bordered table-sm table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $subject->name() }}</td>
                <td>
                    <form action="{{ route('admin.blogs.subject.delete', $subject->id) }}" method="post">
                        @csrf
                        @method('DELETE')
